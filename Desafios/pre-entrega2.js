...
// console.log(typeof nombreStorage);

const checkStorage = () => {
  nombreStorage != undefined ? saludar2() : console.log("Continuar con la app");
};
...
const mostrarCatalogo = () => {
  ...
  searchCart.innerHTML = `<button id="btnBuscar" class="button">Buscar</button>`;
  titulo.className = "tituloModel";
  titulo.appendChild(searchCart);
  botones.className = "nn";
  //   let menuBotones = document.querySelector(".menu");
  //   menuBotones.innerHTML =
  //   let botonBuscar = document.getElementById("btnBuscar");
  //   botonBuscar.onclick = () =>
  //     Swal.fire({
